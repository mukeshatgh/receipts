...
require_once "connection.php";
    ...
    if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE bookslist set  bookname='" . $_POST['bookname'] . "', publication='" . $_POST['publication'] . "' ,class='" . $_POST['class'] . "' ,rate='" . $_POST['rate'] . "' ,quantity='" . $_POST['quantity'] . "' WHERE id='" . $_POST['id'] . "'");
     
     header("location: index.php");
     exit();
    }
    $result = mysqli_query($conn,"SELECT * FROM bookslist WHERE id='" . $_GET['id'] . "'");
